...
void make_Jpsi_mupt(float ptmin=0.0, float ptmax=30.0, float ymin=0.0, float ymax=2.4, bool absRapidity=true, bool saveFile=false)
{
  ...
  TString fname;
  fname = Form("20140324/MC_Jpsi_pp_mupt_Rap_%3.1f-%3.1f_Pt_%3.1f-%3.1f.root",ymin,ymax,ptmin,ptmax);
  ...
  myTree->Add("../root_files/PRMC_Histos_2013pp_GlbGlb_STARTHI53_V28-v1_muLessPV.root");
