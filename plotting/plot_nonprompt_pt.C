void plot_nonprompt_pt()
{
  ...
  TFile *f0 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt03_Histos_cmssw445p5_RegIt.root","READ");
  ...
  TFile *f1 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt36_Histos_cmssw445p5_RegIt.root","READ");
  ...
  TFile *f2 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt69_Histos_cmssw445p5_RegIt.root","READ");
  ...
  TFile *f3 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt912_Histos_cmssw445p5_RegIt.root","READ");
  ...
  TFile *f4 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt1215_Histos_cmssw445p5_RegIt.root","READ");
  ...
  TFile *f5 = new TFile("/data/CMS/MC/PbPb/bJpsiMuMu_JpsiPt1530_Histos_cmssw445p5_RegIt.root","READ");
