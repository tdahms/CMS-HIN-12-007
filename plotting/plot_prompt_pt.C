void plot_prompt_pt()
{
  ...
  TCut genCuts = "abs(Gen_QQ_4mom.Rapidity())<2.4&&Gen_QQ_4mom.Pt()<30.0";
  ...
  TFile *f0 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt03_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
  ...
  TFile *f1 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt36_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
  ...
  TFile *f2 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt69_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
  ...
  TFile *f3 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt912_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
  ...
  TFile *f4 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt1215_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
  ...
  TFile *f5 = new TFile("/data/CMS/MC/PbPb/jpsiMuMu_JpsiPt1530_Histos_cmssw445p1_RegIt.root","READ");
  myTree->SetWeight(1.0);
