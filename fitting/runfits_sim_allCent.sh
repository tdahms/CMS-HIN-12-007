...
SUFFIX="SimFits_M2242_DblMu0_AllCent_maxUncertainties"
...
do
	...
	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracCB -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 &> ${DIRECTORY}/sim_fitCB_polBkg_rap${rap}_pt${pt}_cent${cent}.log
	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1G2 sigCB1G2P ${bkg} -d ${DIRECTORY}/fracCBG -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 &> ${DIRECTORY}/sim_fitCBG_polBkg_rap${rap}_pt${pt}_cent${cent}.log

#	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracCB -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 -a -n -g &> ${DIRECTORY}/sim_fitCB_polBkg_rap${rap}_pt${pt}_cent${cent}_allFree.log
#	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1CB2 sigCB1CB2P ${bkg} -d ${DIRECTORY}/fracCBG -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 -a -n -g &> ${DIRECTORY}/sim_fitCBG_polBkg_rap${rap}_pt${pt}_cent${cent}_allFree.log
	...
	then
	    ...
	    echo "fitting " ${rap} " " ${pt} " " ${cent} " " ${bkg};
	    ./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracCB -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 0 &> ${DIRECTORY}/sim_fitCB_expBkg_rap${rap}_pt${pt}_cent${cent}.log
	    ./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1G2 sigCB1G2P ${bkg} -d ${DIRECTORY}/fracCBG -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 0 &> ${DIRECTORY}/sim_fitCBG_expBkg_rap${rap}_pt${pt}_cent${cent}.log
	fi;
