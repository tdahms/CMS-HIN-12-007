...
do
	...
	do
	    ...
	    ./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent${cent}_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracLogCB -p ${pt} -y ${rap} -t ${cent} -l 1 -b 1 -s 0 &> ${DIRECTORY}/sim_fitCB_rap${rap}_pt${pt}_cent${cent}.log
	    ./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent${cent}_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1G2 sigCB1G2P ${bkg} -d ${DIRECTORY}/fracLogCBG -p ${pt} -y ${rap} -t ${cent} -l 1 -b 1 -s 0 &> ${DIRECTORY}/sim_fitCBG_rap${rap}_pt${pt}_cent${cent}.log
	done;
    done;
done;
