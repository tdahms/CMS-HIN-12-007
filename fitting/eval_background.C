void eval_background(bool isHI=true)
{
  ...
  if (isHI) {
    ...
    myTree->Draw("Reco_QQ_4mom.M()>>h1(100,2.2,4.2)","(Reco_QQ_trig&1)==1&&Reco_QQ_sign==0&&Reco_QQ_4mom.Pt()>6.5&&Reco_QQ_4mom.Pt()<30.0&&abs(Reco_QQ_4mom.Rapidity())>0.0&&abs(Reco_QQ_4mom.Rapidity())<1.6","e");
    myTree->Draw("Reco_QQ_4mom.M()>>h2(100,2.2,4.2)","(Reco_QQ_trig&1)==1&&Reco_QQ_sign!=0&&Reco_QQ_4mom.Pt()>6.5&&Reco_QQ_4mom.Pt()<30.0&&abs(Reco_QQ_4mom.Rapidity())>0.0&&abs(Reco_QQ_4mom.Rapidity())<1.6","e");
  }
  else {
    ...
    myTree->Draw("Reco_QQ_4mom.M()>>h2(100,2.2,4.2)","(Reco_QQ_trig&2)==2&&Reco_QQ_sign!=0&&Reco_QQ_4mom.Pt()>6.5&&Reco_QQ_4mom.Pt()<30.0&&abs(Reco_QQ_4mom.Rapidity())>0.0&&abs(Reco_QQ_4mom.Rapidity())<1.6","e");
  }
