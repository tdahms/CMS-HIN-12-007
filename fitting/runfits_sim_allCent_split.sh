...
SUFFIX="SimFits_M2242_DblMu0_AllCent_splitFit"
...
do
	...
	then
	    bkg="pol1_HI020 pol1_HI2040 pol1_HI40100 pol1";
	...
	./Fit1DDataPbPbSimSplit -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracLogCB -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 0 &> ${DIRECTORY}/sim_fitCB_polBkg_rap${rap}_pt${pt}_cent${cent}.log
	./Fit1DDataPbPbSimSplit -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1G2 sigCB1G2P ${bkg} -d ${DIRECTORY}/fracLogCBG -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 0 &> ${DIRECTORY}/sim_fitCBG_polBkg_rap${rap}_pt${pt}_cent${cent}.log

#	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v signalCB1 signalCB1P ${bkg} -d ${DIRECTORY}/fracLogCB -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 -a -n -g &> ${DIRECTORY}/sim_fitCB_polBkg_rap${rap}_pt${pt}_cent${cent}_allFree.log
#	./Fit1DDataPbPbSim -f ../root_files/PbPbData2011_DblMu0_cent0-20_M22-42.root ../root_files/PbPbData2011_DblMu0_cent20-40_M22-42.root ../root_files/PbPbData2011_DblMu0_cent40-100_M22-42.root ../root_files/ppData2013_DblMu0_cent0-100_M22-42.root -v sigCB1CB2 sigCB1CB2P ${bkg} -d ${DIRECTORY}/fracLogCBG -p ${pt} -y ${rap} -t Mult -l 0 -b 1 -s 0 -u 1 -x 0 -z 1 -a -n -g &> ${DIRECTORY}/sim_fitCBG_polBkg_rap${rap}_pt${pt}_cent${cent}_allFree.log
...
#	    if [[ ${pt} == "6.5-30.0" && ${rap} == "0.0-2.4" ]];
#	    then
#		bkg="SinCos_HI020 SinCos_HI2040 SinCos_HI40100 SinCos";
#	    elif [[ ${pt} == "6.5-30.0" && ${rap} == "0.0-1.6" ]];
#	    then
#		bkg="SinCos_HI020 SinCos_HI2040 SinCos_HI40100 SinCos";
#	    elif [[ ${pt} == "3.0-30.0" && ${rap} == "1.6-2.4" ]];
...
#	    if [[ ${pt} == "6.5-30.0" && ${rap} == "0.0-2.4" ]];
#	    then
#		bkg="gammaBkg_HI020 gammaBkg_HI2040 gammaBkg_HI40100 gammaBkg";
#	    elif [[ ${pt} == "6.5-30.0" && ${rap} == "0.0-1.6" ]];
#	    then
#		bkg="gammaBkg_HI020 gammaBkg_HI2040 gammaBkg_HI40100 gammaBkg";
#	    elif [[ ${pt} == "3.0-30.0" && ${rap} == "1.6-2.4" ]];
